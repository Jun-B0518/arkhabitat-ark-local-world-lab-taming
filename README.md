...
<div align="center">
  <img src="./public/logo.svg" alt="ArkHabitat — ARK: Survival Ascended — Taming" width="64" height="64">
  <h1>ArkHabitat — ARK: Survival Ascended — Taming</h1>
</div>

An independent project specification for ARK: Survival Ascended, covering local progression presets, taming budget worksheets, world restore checklist.
...
<img src="./public/screenshots/desktop-main.svg" alt="ARK: Survival Ascended — desktop concept, not a screenshot" width="520">
<br>
<em>Three proposed modules, not implemented features</em>
</td>
<td align="center">
<h3>Compact Concept</h3>
<img src="./public/screenshots/mobile-overview.svg" alt="ARK: Survival Ascended — compact concept, not a screenshot" width="250">
<br>
...
- **Local progression presets** — planned module; not implemented.
- **Taming budget worksheets** — planned module; not implemented.
- **World restore checklist** — planned module; not implemented.

The proposed workflow separates local progression presets from taming budget worksheets, with world restore checklist retained for reproducibility. These are design goals, not claims about existing functionality.
...
3. Describe one baseline scenario for **Local progression presets**.
...
<div align="center">
<img src="./public/screenshots/review-workflow.svg" width="700" alt="ArkHabitat — ARK: Survival Ascended — Taming — specification review workflow">
<br>
...
### Local progression presets

Define the input and expected outcome for module 1. Record the ARK: Survival Ascended version, scenario conditions, and known limitations. Completing these notes manually does not establish that an automated tool exists.

### Taming budget worksheets

Define the input and expected outcome for module 2. Record the ARK: Survival Ascended version, scenario conditions, and known limitations. Completing these notes manually does not establish that an automated tool exists.

### World restore checklist

Define the input and expected outcome for module 3. Record the ARK: Survival Ascended version, scenario conditions, and known limitations. Completing these notes manually does not establish that an automated tool exists.

### At a glance

| Field | Value |
|---|---|
| Target | ARK: Survival Ascended |
| Category | Offline game project |
| Input | Manual notes or user-authorized local exports |
| Planned output | Local progression presets |
