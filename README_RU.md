...
Проект помощника настройки ресурсов и развития в собственном одиночном мире.
...
- **Local progression presets** — запланированный модуль; реализации нет.
- **Taming budget worksheets** — запланированный модуль; реализации нет.
- **World restore checklist** — запланированный модуль; реализации нет.
...
3. Опишите один контрольный сценарий для **Local progression presets**.
...
Зафиксируйте входные данные и ожидаемый результат для модуля 1. Запишите версию ARK: Survival Ascended, условия сценария и известные ограничения. Выполнение этих действий вручную не подтверждает наличие автоматизированного инструмента.

### Taming budget worksheets

Зафиксируйте входные данные и ожидаемый результат для модуля 2. Запишите версию ARK: Survival Ascended, условия сценария и известные ограничения. Выполнение этих действий вручную не подтверждает наличие автоматизированного инструмента.

### World restore checklist

Зафиксируйте входные данные и ожидаемый результат для модуля 3. Запишите версию ARK: Survival Ascended, условия сценария и известные ограничения. Выполнение этих действий вручную не подтверждает наличие автоматизированного инструмента.

### Кратко

| Поле | Значение |
|---|---|
| Продукт или область | ARK: Survival Ascended |
...
| Планируемый результат | Local progression presets |
